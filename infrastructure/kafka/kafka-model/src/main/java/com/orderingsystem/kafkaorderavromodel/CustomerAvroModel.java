...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5698314449431906825L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerAvroModel\",\"namespace\":\"com.orderingsystem.kafkaorderavromodel\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"username\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder newBuilder() {
    return new com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder();
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder newBuilder(com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder other) {
    if (other == null) {
      return new com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder();
    } else {
      return new com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder newBuilder(com.orderingsystem.kafkaorderavromodel.CustomerAvroModel other) {
    if (other == null) {
      return new com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder();
    } else {
      return new com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.orderingsystem.kafkaorderavromodel.CustomerAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder setUsername(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.orderingsystem.kafkaorderavromodel.CustomerAvroModel.Builder clearLastName() {
      lastName = null;
